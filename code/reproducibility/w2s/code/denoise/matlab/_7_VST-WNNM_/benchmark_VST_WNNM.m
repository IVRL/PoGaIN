...
for i_repeat = 1:n_repeat
    ...
    [denoise_avg1, time_avg1] = denoise_VST_WNNM(img_avg1);
    [denoise_avg2, time_avg2] = denoise_VST_WNNM(img_avg2);
    [denoise_avg4, time_avg4] = denoise_VST_WNNM(img_avg4);
    [denoise_avg8, time_avg8] = denoise_VST_WNNM(img_avg8);
    [denoise_avg16, time_avg16] = denoise_VST_WNNM(img_avg16);
