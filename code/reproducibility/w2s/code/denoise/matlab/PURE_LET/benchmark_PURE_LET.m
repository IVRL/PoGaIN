...
addpath('./code')
addpath('./code/Denoising');
addpath('./code/diagDR');
addpath('./code/Transforms');
...
for i_repeat = 1:n_repeat
    ...
    [denoise_avg1, time_avg1] = denoise_PURE_LET(img_avg1);
    [denoise_avg2, time_avg2] = denoise_PURE_LET(img_avg2);
    [denoise_avg4, time_avg4] = denoise_PURE_LET(img_avg4);
    [denoise_avg8, time_avg8] = denoise_PURE_LET(img_avg8);
    [denoise_avg16, time_avg16] = denoise_PURE_LET(img_avg16);
