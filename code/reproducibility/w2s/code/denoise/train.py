...
from models import RIDNET, DnCNN, DnCNN_BUIFD, MemNet, MemNet_BUIFD
...
parser.add_argument(
    ...
    type=int,
    default=30,
    help="When to decay learning rate; should be < epochs",
)

parser.add_argument("--patch_size", type=int, default=64, help="patch size")
parser.add_argument(
    "--stride", type=int, default=32, help="stride used for creating training patches"
)
...
def main():
    ...
    loader = DataLoader(
        dataset=dataset, num_workers=4, batch_size=opt.batch_size, shuffle=True
    )
