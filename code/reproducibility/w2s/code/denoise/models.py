...
from RIDmodel import common, ops
...
class MemNet_BUIFD(nn.Module):
    def __init__(self, in_channels):
        ...
        self.memnet = MemNet(
            in_channels=in_channels, channels=20, num_memblock=6, num_resblock=4
        )
...
class RIDNET(nn.Module):
    def __init__(self, in_channels):
        ...
        self.sub_mean = common.MeanShift(
            rgb_range, rgb_mean, rgb_std, in_channels=in_channels
        )
        self.add_mean = common.MeanShift(
            rgb_range, rgb_mean, rgb_std, sign=1, in_channels=in_channels
        )
